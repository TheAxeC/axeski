 ...
 *
 */
public class PrintView extends BlockView {
	...
	public PrintView(Observable model, Controller controller, IDEPanel p, LanguageModule lang) {
	...
	public static JPanel getRepresentative(LanguageModule lang){
		return new JPanel() {
...

			{
				setOpaque(false);
				setLayout(null);
				JLabel title = new JLabel(lang.getString("Bprint"));
	...
	public void addComponents() {
		_title = new JLabel(_lang.getString("Bprint"));
	...
	public BlockView getBlockToUnsnap(int x, int y) {
		...
		if (rec == _body){
			((PrintViewController)getController()).removeContent(_body);
			_body = null;
		}
	...
	public Component add(Component comp) {
		...
		((PrintViewController)getController()).addContent((BlockView) comp);
		return comp;
	}
	...
	protected boolean acceptBlock(Component comp) {
		return ((PrintViewController)getController()).acceptSingle((BlockView) comp);
	}

	@Override
	public Controller defaultController(Observable model) {
		return new PrintViewController(getModel());
	}
	...
	public void updateLanguage() {
		_title.setText(_lang.getString("Bprint"));
	}
	...
	public String getHelpMenu() {
		return _lang.getString("BprintHelp");
	}
