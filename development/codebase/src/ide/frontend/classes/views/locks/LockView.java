...
/**
 * View for locking a variable. View for LockModel
 * @author axel
 *
 */
public class LockView extends BlockView{
	...
	public LockView(Observable model, Controller controller, IDEPanel p, LanguageModule lang) {
	...
	public static JPanel getRepresentative(LanguageModule lang){
		return new JPanel() {
...

			{
				setOpaque(false);
				setLayout(null);
				JLabel title = new JLabel(lang.getString("Block"));
	...
	public void addComponents() {
		_title = new JLabel(_lang.getString("Block"));
	...
	public BlockView getBlockToUnsnap(int x, int y) {
		...
		if(_ref != null && _ref.containsBlock(x, y)){
			rec = _ref;
			((LockController)getController()).removeReference();
			_ref = null;
		}
	...
	public Component add(Component comp) {
		...
		((LockController)getController()).setReference((BlockView) comp);
		return comp;
	...
	protected boolean acceptBlock(Component comp) {
		return ((LockController)getController()).acceptVar((BlockView) comp);
	}

	@Override
	public Controller defaultController(Observable model) {
		return new LockController(getModel());
	}
	...
	public void updateLanguage() {
		_title.setText(_lang.getString("Block"));
	}
	...
	public String getHelpMenu() {
		return _lang.getString("BlockHelp");
	}
