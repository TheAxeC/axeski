...
/**
 * View for getting length of a string. View for LengthModel.
 * @author Axel
 *
 */
public class LengthView extends BlockView {
	...
	public LengthView(Observable model, Controller controller, IDEPanel p, LanguageModule lang) {
	...
	public static JPanel getRepresentative(LanguageModule lang){
		return new JPanel() {
...

			{
				setOpaque(false);
				setLayout(null);
				JLabel title = new JLabel(lang.getString("Blength"));
	...
	public void addComponents() {
		_title = new JLabel(_lang.getString("Blength"));
	...
	public void makeShapes() {
		...
		if(((LengthController)getController()).getError())
	...
	public BlockView getBlockToUnsnap(int x, int y) {
		...
		if (rec == _body){
			((LengthController)getController()).removeContent(_body);
			_body = null;
		}
	...
	public Component add(Component comp) {
		...
		((LengthController)getController()).addContent((BlockView) comp);
		return comp;
	}
	...
	protected boolean acceptBlock(Component comp) {
		return ((LengthController)getController()).acceptSingle((BlockView) comp);
	}

	@Override
	public Controller defaultController(Observable model) {
		return new LengthController(getModel());
	}
	...
	public void updateLanguage() {
		_title.setText(_lang.getString("Blength"));
	}
	...
	public String getHelpMenu() {
		return _lang.getString("BlengthHelp");
	}
}