...
/**
 * View for the hideblock.
 * @author matthijs
 *
 */
public class HideView extends BlockView{
	...
	public HideView(Observable model, Controller controller, IDEPanel p, LanguageModule lang) {
	...
	public static JPanel getRepresentative(LanguageModule lang){
		return new JPanel() {
...

			{
				setOpaque(false);
				setLayout(null);
				JLabel title = new JLabel(lang.getString("Bhide"));
	...
	public void updateLanguage() {
		_title.setText(_lang.getString("Bhide"));
	}
	...
	public String getHelpMenu() {
		return _lang.getString("BhideHelp");
	}
}
