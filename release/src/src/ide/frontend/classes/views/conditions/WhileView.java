 ...
 *
 */
public class WhileView extends BlockView {
	...
	public WhileView(Observable model, Controller controller, IDEPanel p, LanguageModule lang) {
	...
	public static JPanel getRepresentative(LanguageModule lang){
		return new JPanel() {
...

			{
				setOpaque(false);
				setLayout(null);
				JLabel title = new JLabel(lang.getString("Bwhile"));
	...
	public void set(int x, int y) {
		...
		AnchorBlock b = new AnchorBlock(((WhileViewController)getController()).getBodymodel(), null, getPanel(), getLang());
		b.set(0, 0);
		setBody(b);
	}
	...
	public void addComponents() {
		_title = new JLabel(_lang.getString("Bwhile"));
	...
	public void makeShapes() {
		...
		if(((WhileViewController)getController()).getError())
	...
	public BlockView getBlockToUnsnap(int x, int y) {
		...
		if (_body.canUnsnap()) {
			...
			if (rec == _body) {
				...
				AnchorBlock b = new AnchorBlock(((WhileViewController)getController()).resetBody(), null, getPanel(), getLang());
				b.set(0, 0);
				setBody(b);
		...
		if (rec == null && _cond != null) {
			...
			if (rec == _cond){
				((WhileViewController)getController()).removeCondition();
				_cond = null;
			}
		}
	...
	public Component add(Component comp) {
		...
		if (_addCondition) {
			((WhileViewController)getController()).setCondition(_cond);
		}
		return comp;
	}
	...
	/**
	 * Adds the view of the condition to this whileView
	 * @param comp
	 * @return
	 */
	...
	public Controller defaultController(Observable model) {
		return new WhileViewController(getModel());
	}

	@Override
	public void updateLanguage() {
		_title.setText(_lang.getString("Bwhile"));
	}
	...
	public String getHelpMenu() {
		return _lang.getString("BwhileHelp");
	}
}
