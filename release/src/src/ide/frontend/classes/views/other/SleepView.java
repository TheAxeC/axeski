...
/**
 * The View representing the sleep block
 * @author axel
 *
 */
public class SleepView extends BlockView {
	...
	public SleepView(Observable model, Controller controller, IDEPanel p, LanguageModule lang) {
	...
	public static JPanel getRepresentative(LanguageModule lang){
		return new JPanel() {
...

			{
				setOpaque(false);
				setLayout(null);
				JLabel title = new JLabel(lang.getString("Bsleep"));
	...
	public void addComponents() {
		_title = new JLabel(_lang.getString("Bsleep"));
	...
	public BlockView getBlockToUnsnap(int x, int y) {
		...
		if(_ref != null && _ref.containsBlock(x, y)){
			rec = _ref;
			((SleepController)getController()).removeContent();
			_ref = null;
		}
	...
	public Component add(Component comp) {
		...
		((SleepController)getController()).setContent((BlockView) comp);
		return comp;
	...
	protected boolean acceptBlock(Component comp) {
		return ((SleepController)getController()).acceptSingle((BlockView) comp);
	}

	@Override
	public Controller defaultController(Observable model) {
		return new SleepController(getModel());
	}
	...
	public void updateLanguage() {
		_title.setText(_lang.getString("Bsleep"));
	}
	...
	public String getHelpMenu() {
		return _lang.getString("BsleepHelp");
	}
}
